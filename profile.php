                  ...
                  <div class="profile-cover-button">
                    ...
                    <div class="profile-action-wrap">
                      ...
                      <div class="profile-friend-confirm" data-userid="<?php echo $userId ?>"
                        data-profileid="<?php echo $profileId ?>">
                        <div class="edit-profile-confirm-button">
                      ...
                      <div class="profile-friend-confirm" data-userid="<?php echo $userId ?>"
                        data-profileid="<?php echo $profileId ?>">
                        <div class="edit-profile-confirm-button">
                          <div class="confirm-request d-flex align-items-center" data-userid="<?php echo $userId ?>"
                            data-profileid="<?php echo $profileId ?>">
                            <i class="fa-solid fa-user-check"></i>
                            <p class="edit-profile-button-text">
                              Friend
  ...
  $(function() {
    ...
    $(document).on('click', '.post-option-icon', function() {
      ...
      $(postDetails).show().html(
        ...
        postId + '" data-userid="' + userId + '"><i class="fa-regular fa-lock me-1"></i>Privacy</li></ul>');
    })
    ...
    $(document).on('click', '.com-dot', function() {
      ...
      $(comDetails).show().html(
        '<ul class="com-option-details p-0 m-0"><li class="com-edit com-option-item" data-postid="' + postid +
    ...
    $(document).on('click', 'li.com-edit', function() {
      var comTextContainer = $(this).parents('.com-dot-option-wrap').siblings('.com-pro-text').find(
        '.com-text');
    ...
    $(document).on('click', '.edit-com-save', function() {
      ...
      var userid = $(this).data('userid');
      var commentid = $(this).data('commentid');
      var editedText = $(this).parents('.edit-comment-submit').siblings('.edit-comment-value').find('.editCom');
      var editedTextVal = $(editedText).val();
    ...
    */
    ...
    $(document).on('click', '.reply-dot', function() {
      ...
      $(replyDetails).html(
        ...
        postid + '" data-userid="' + userid +
        '" data-commentid="' + commentid +
        '" data-replyid="' + replyid + '"><i class="fa-regular fa-trash me-1"></i>Delete</li></ul>');
    })

    $(document).on('click', 'li.reply-edit', function() {
      var comTextContainer = $(this).parents('.reply-dot-option-wrap').siblings('.com-pro-text').find(
        '.com-text');
    ...
    $(document).on('click', '.edit-reply-save', function() {
      ...
      var commentid = $(this).data('commentid');
      var replyid = $(this).data('replyid');
      var editedText = $(this).parents('.edit-comment-submit').siblings('.edit-comment-value').find(
        '.editReply');
      var editedTextVal = $(editedText).val();
    ...
    $(document).on('click', '.post-Share', function() {
      ...
      var userid = $(this).data('userid');
      var profileid = $(this).data('profileid');
      var shareText = $(this).parents('.share-post-submit').siblings('.share-post-value').find('.shareText')
        .val();
    ...
    $(document).on('click', '.accept-request', function() {
      var userid = $(this).data('userid');
      var profileid = $(this).data('profileid');
      $(this).parent().empty().html('<div class="confirm-request d-flex align-items-center" data-userid="' +
    ...
    $(document).on('click', '.request-cancel', function() {
      $(this).parents('.profile-friend-confirm').removeClass().addClass('profile-add-friend').html(
